...
@Component({
  selector: 'app-voice-otp',
  templateUrl: './voice-otp.component.html',
  styleUrls: ['./voice-otp.component.scss']
})
export class VoiceOtpComponent implements OnInit {
  ...
  modalOpen(modal, item = null) {
    if (item) {
      this.titleModal = "Cập nhật Voice OTP";
      this.isCreate = false;
      ...
      this.titleModal = "Thanh toán Voice OTP";
      this.isCreate = true;
      this.modalRef = this.modalService.open(modal, {
        centered: true,
        windowClass: 'modal modal-primary',
