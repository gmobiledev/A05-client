...
export class DetailServiceComponent implements OnInit {
  ...
  chartDetail = {
    title: 'Airtime',
    subtitle: 'Người đăng ký đã đạt được'
  }
  btnNap = 'Nạp tiền';
  currentService;
  paymentRouterLink = '/payment/list';
  ...
  constructor(
    ...
    if(this.currentService == ServiceCode.ADD_MONEY_BALANCE) {
      this.chartDetail.title = 'Số dư';
      this.chartDetail.subtitle = 'Số tiền nạp';
      this.paymentRouterLink = '/task/balance'
      this.contentHeader.headerTitle = 'Số dư tài khoản';
      this.contentHeader.breadcrumb.links[1].name = 'Số dư tài khoản';
    } else if(this.currentService == ServiceCode.ADD_DATA_BALANCE) {
      this.btnNap = 'Mua Data';
      this.chartDetail.title = 'Số Data';
      this.chartDetail.subtitle = 'Số Data đã mua';
      this.paymentRouterLink = '/task/data'
      this.contentHeader.headerTitle = 'Số dư Data';
      this.contentHeader.breadcrumb.links[1].name = 'Số dư Data';
    }
  ...
  toggleBalanceTextType() {
    this.userService.showBanalace(this.currentService).subscribe(res => {
